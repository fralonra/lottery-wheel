(function (global, factory) {
  ...
  function dropShadow (rootEl, el, attrs = {}) {
  ...
  function rotate (el, r, cx = 0, cy = 0) {
  ...
  class Wheel {
    ...
    _drawButton () {
      ...
      const button = path(pathD, { fill: opt.color.button });
      dropShadow(this._svg, button, {
        blurStdDeviation: 3,
        offsetDy: 3
      });
